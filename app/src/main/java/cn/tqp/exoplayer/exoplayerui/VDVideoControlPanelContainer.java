...
// * @author seven
// */
//public class VDVideoControlPanelContainer extends View {
//
...
//                R.styleable.ControlPanelContainer);
...
//                        if (controller != null)
//                            controller.touchScreenVerticalScrollEvent(
...
//                        if (controller != null) {
//                            controller.isDragScreenSeek = true;
//                            Log.i("VideoFragment", "滑动开始controller.isDragScreenSeek:" + controller.isDragScreenSeek);
